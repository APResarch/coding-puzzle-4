...
goog.DEPENDENCIES_ENABLED && (goog.dependencies_ = {
    ...
    if (goog.inHtmlDocument_()) {
        ...
        else c.write('<script type="text/javascript">' + b + "\x3c/script>");
        return !0
    }
    return !1
    ...
    if (!goog.transpiledLanguages_) {
        ...
        try {
            goog.transpiledLanguages_.es5 = eval("[1,].length!=1"), eval('(()=>{"use strict";let a={};const X=class{constructor(){}x(z){return new Map([...arguments]).get(z[0])==3}};return new X().x([a,3])})()') &&
...
}, goog.transpiledLanguages_ = null, goog.lastNonModuleScriptIndex_ = 0, goog.onScriptLoad_ = function(a,
    b) {
...
Blockly.Connection.prototype.isConnectionAllowed = function(a) {
    ...
    return a.type == Blockly.INPUT_VALUE && a.isConnected() && !a.targetBlock().isMovable() && !a.targetBlock().isShadow() || this.type == Blockly.PREVIOUS_STATEMENT && a.isConnected() && !this.sourceBlock_.nextConnection || -1 != Blockly.draggingConnections_.indexOf(a) ? !1 :
        !0
};
...
Blockly.Options.prototype.setMetrics = function() {};
...
Blockly.Scrollbar = function(a, b, c) {
    ...
    this.onMouseDownHandleWrapper_ = Blockly.bindEvent_(this.svgHandle_, "mousedown", this, this.onMouseDownHandle_)
};
...
Blockly.Scrollbar.prototype.constrainHandle_ = function(a) {
    return a = 0 >= a || isNaN(a) ? 0 : Math.min(a, this.scrollViewSize_ - this.handleLength_)
};
...
Blockly.BlockSvg.terminateDrag = function() {
    ...
    if (Blockly.dragMode_ == Blockly.DRAG_FREE && a) {
        ...
        Blockly.resizeSvgContents(a.workspace)
    }
    Blockly.dragMode_ =
        Blockly.DRAG_NONE;
...
Blockly.BlockSvg.prototype.onMouseUp_ = function(a) {
    ...
    Blockly.terminateDrag_();
    Blockly.selected && Blockly.highlightedConnection_ ? (Blockly.localConnection_.connect(Blockly.highlightedConnection_), this.rendered && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ : Blockly.localConnection_).getSourceBlock().connectionUiEffect(), this.workspace.trashcan &&
        this.workspace.trashcan.close()) : !this.getParent() && Blockly.selected.isDeletable() && this.workspace.isDeleteArea(a) && ((a = this.workspace.trashcan) && goog.Timer.callOnce(a.close, 100, a), a = Blockly.selected.workspace, Blockly.selected.dispose(!1, !0), Blockly.resizeSvgContents(a));
...
Blockly.BlockSvg.prototype.render = function(a) {
    ...
    !1 !== a && ((a = this.getParent()) ? a.render(!0) : Blockly.resizeSvgContents(this.workspace));
    Blockly.Field.stopCache()
};
...
Blockly.Flyout.prototype.show = function(a) {
    ...
    this.listeners_.push(Blockly.bindEvent_(this.svgBackground_, "mouseover", this, function() {
...
Blockly.Toolbox.prototype.populate_ = function(a) {
    function b(a, g, h) {
        for (var k = null, m = 0, p; p = a.childNodes[m]; m++)
            if (p.tagName) switch (p.tagName.toUpperCase()) {
                case "CATEGORY":
                    k = c.createNode(p.getAttribute("name"));
                    k.blocks = [];
                    g.add(k);
                    var l = p.getAttribute("custom");
                    l ? k.blocks = l : b(p, k, h);
                    l = p.getAttribute("colour");
                    goog.isString(l) ? (l.match(/^#[0-9a-fA-F]{6}$/) ? k.hexColour = l : k.hexColour = Blockly.hueToRgb(l), e = !0) : k.hexColour = "";
                    "true" == p.getAttribute("expanded") ? (k.blocks.length && c.setSelectedItem(k), k.setExpanded(!0)) :
                        k.setExpanded(!1);
                    k = p;
                    break;
                case "SEP":
                    k && ("CATEGORY" == k.tagName.toUpperCase() ? g.add(new Blockly.Toolbox.TreeSeparator(d.treeSeparatorConfig_)) : (p = parseFloat(p.getAttribute("gap")), isNaN(p) || (l = parseFloat(k.getAttribute("gap")), p = isNaN(l) ? p : l + p, k.setAttribute("gap", p))));
                    break;
                case "BLOCK":
                case "SHADOW":
                    g.blocks.push(p), k = p
...
Blockly.init_ = function(a) {
    ...
    b.languageTree && (a.toolbox_ ? a.toolbox_.init(a) : a.flyout_ && (a.flyout_.init(a), a.flyout_.show(b.languageTree.childNodes), a.flyout_.scrollToStart(), a.scrollX = a.flyout_.width_, b.toolboxPosition ==
        Blockly.TOOLBOX_AT_RIGHT && (a.scrollX *= -1), a.translate(a.scrollX, 0)));
